...
@[extern "lean_sqlite3_step"]     opaque Cursor.step (Cursor: Cursor) : IO Bool -- false=done, true=more
@[extern "lean_sqlite3_boot"]     opaque Cursor.boot (Cursor: Cursor) : IO Unit

@[extern "lean_sqlite3_bind_num"] opaque Cursor.binds (Cursor: Cursor): IO UInt32
@[extern "lean_sqlite3_bind_i32"] opaque Cursor.bindUInt32 (Cursor: Cursor) (iCol: UInt32) (v: UInt32): IO Unit
@[extern "lean_sqlite3_bind_i64"] opaque Cursor.bindUInt64 (Cursor: Cursor) (iCol: UInt32) (v: UInt64): IO Unit
@[extern "lean_sqlite3_bind_dbl"] opaque Cursor.bindFloat  (Cursor: Cursor) (iCol: UInt32) (v: Float):  IO Unit
@[extern "lean_sqlite3_bind_txt"] opaque Cursor.bindString (Cursor: Cursor) (iCol: UInt32) (v: String): IO Unit
@[extern "lean_sqlite3_bind_nll"] opaque Cursor.bindNull   (Cursor: Cursor) (iCol: UInt32): IO Unit
